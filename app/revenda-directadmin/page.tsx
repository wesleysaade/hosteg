...
export const metadata: Metadata = {
  title: 'Revenda de Hospedagem DirectAdmin — Hosteg',
  description: 'Revenda hospedagem com DirectAdmin. White-label, painel leve e rápido, WHMCS compatível. A partir de R$ 79/mês.',
}

const directAdminVantagens = [
  { icon: Lightning,   title: 'Painel Mais Leve do Mercado',   desc: 'DirectAdmin usa menos recursos que cPanel, resultando em mais performance para os sites dos seus clientes com o mesmo hardware.' },
  ...
  { icon: Desktop,     title: 'Preço Mais Competitivo',         desc: 'DirectAdmin tem licença mais acessível que cPanel, permitindo oferecer preços competitivos para seus clientes finais.' },
  { icon: CheckCircle, title: 'Migração do cPanel Incluída',    desc: 'Se você tem clientes em cPanel, migramos tudo para DirectAdmin gratuitamente. O processo é transparente para seus clientes.' },
]

const faqs = [
  { q: 'DirectAdmin é igual ao cPanel?', a: 'É similar em funcionalidades — os clientes gerenciam arquivos, e-mails, bancos de dados e domínios — mas é mais leve e rápido. Tem pequenas diferenças de interface que a maioria dos usuários adapta em poucos minutos.' },
  { q: 'WHMCS funciona com DirectAdmin?', a: 'Sim! DirectAdmin tem integração oficial com WHMCS via módulo de hospedagem. Você pode automatizar toda a gestão de clientes e cobranças.' },
  { q: 'Posso migrar do cPanel para DirectAdmin?', a: 'Sim, nossa equipe cuida de toda a migração gratuitamente. Sites, e-mails e bancos de dados são migrados sem downtime.' },
  { q: 'Qual a diferença de preço entre cPanel e DA?', a: 'Os planos DirectAdmin são em média 20% mais baratos que os equivalentes cPanel, pois a licença DirectAdmin tem custo inferior.' },
]
    ...
    <div className="min-h-screen bg-white text-zinc-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50/60 p-8 flex flex-col sm:flex-row items-center gap-6">
            <div className="w-14 h-14 rounded-2xl bg-emerald-100 flex items-center justify-center flex-shrink-0">
              <img src="https://cdn.simpleicons.org/directadmin/1F6FEB" alt="DirectAdmin" width={28} height={28} />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 text-[#0EA5E9] text-xs font-bold uppercase tracking-widest mb-3">
              <Lightning size={13} weight="fill" /> Por que DirectAdmin?
            </div>
            <h2 className="text-3xl font-black text-zinc-900 mb-3">Mais performance, menor custo</h2>
            <p className="text-zinc-500 max-w-lg mx-auto">DirectAdmin é a escolha de quem quer entregar mais por menos.</p>
          </div>
      ...
      <section className="py-16 border-t border-zinc-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black text-zinc-900 mb-8 text-center">Dúvidas sobre DirectAdmin</h2>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://painelcliente.com.br" target="_blank" rel="noopener noreferrer"
              ...
              Contratar Revenda DA <ArrowRight size={15} weight="bold" />
            </a>
            <Link href="/contato"
